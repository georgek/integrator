                ...
                * by splicing */
                    ...
                    *root = r->u.op2.operand1;
                    ...
                    sub_poly_rat(&r->u.op2.operand2->u.poly,
                                 r->u.op2.operand2->u.poly,
                                 r->u.op2.operand1->u.rat);
                    negate_polynomial(&r->u.op2.operand2->u.poly);
                    *root = r->u.op2.operand2;
                    r->u.op2.operand2 = NULL;
                    free_tree(r);
               }
...
void extract_ratfuns(node_type **root)
{
     ...
     case op2_type:
          ...
          case '*':
               if (r->u.op2.operand1->type == rat_type
                   && r->u.op2.operand2->type == ratfun_type) {
                    /* rat * ratfun = ratfun */
                    mul_ratfun_rat(&r->u.op2.operand2->u.ratfun,
                    ...
                    *root = r->u.op2.operand2;
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == poly_type) {
                    /* ratfun * poly = ratfun */
                    mul_ratfun_poly(&r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand2->u.poly);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == ratfun_type) {
                    /* poly * ratfun = ratfun */
                    mul_ratfun_poly(&r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand1->u.poly);
                    *root = r->u.op2.operand2;
                    r->u.op2.operand2 = NULL;
                    ...
                    *root = r->u.op2.operand1;
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == rat_type) {
                    /* ratfun * rat = ratfun */
                    mul_ratfun_rat(&r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand2->u.rat);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
          ...
          case '/':
               if (r->u.op2.operand1->type == poly_type
                   && r->u.op2.operand2->type == poly_type) {
                    /* poly / poly = ratfun */
                    *root = add_ratfun(r->u.op2.operand1->u.poly,
                                       r->u.op2.operand2->u.poly);
                    r->u.op2.operand1->u.poly.head = NULL;
               ...
               if (r->u.op2.operand1->type == rat_type
                    ...
                    *root = add_ratfun2(r->u.op2.operand1->u.rat,
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == poly_type) {
                    /* ratfun / poly = ratfun */
                    div_ratfun_poly(&r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand2->u.poly);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    ...
                    *root = r->u.op2.operand2;
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == rat_type) {
                    /* ratfun / rat = ratfun */
                    div_ratfun_rat(&r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand2->u.rat);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
               ...
               if (r->u.op2.operand1->type == ratfun_type
                    ...
                    *root = r->u.op2.operand1;
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == poly_type) {
                    /* ratfun + poly = ratfun */
                    add_ratfun_poly(&r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand2->u.poly);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == ratfun_type) {
                    /* poly + ratfun = ratfun */
                    add_ratfun_poly(&r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand1->u.poly);
                    *root = r->u.op2.operand2;
                    r->u.op2.operand2 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == rat_type) {
                    /* ratfun + rat = ratfun */
                    add_ratfun_rat(&r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand2->u.rat);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == ratfun_type) {
                    /* rat + ratfun = ratfun */
                    add_ratfun_rat(&r->u.op2.operand2->u.ratfun,
                                   r->u.op2.operand2->u.ratfun,
                                   r->u.op2.operand1->u.rat);
                    *root = r->u.op2.operand2;
                    r->u.op2.operand2 = NULL;
               ...
               if (r->u.op2.operand1->type == ratfun_type
                    ...
                    *root = r->u.op2.operand1;
                    ...
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == poly_type) {
                    /* ratfun - poly = ratfun */
                    sub_ratfun_poly(&r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand1->u.ratfun,
                                    r->u.op2.operand2->u.poly);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == ratfun_type) {
                    /* poly - ratfun = ratfun */
                    sub_ratfun_poly(&r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand2->u.ratfun,
                                    r->u.op2.operand1->u.poly);
                    negate_ratfun(&r->u.op2.operand2->u.ratfun);
                    *root = r->u.op2.operand2;
                    r->u.op2.operand2 = NULL;
                    free_tree(r);
               }
                        ...
                        && r->u.op2.operand2->type == rat_type) {
                    /* ratfun - rat = ratfun */
                    sub_ratfun_rat(&r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand1->u.ratfun,
                                   r->u.op2.operand2->u.rat);
                    *root = r->u.op2.operand1;
                    r->u.op2.operand1 = NULL;
                    free_tree(r);
                        ...
                        && r->u.op2.operand2->type == ratfun_type) {
                    /* rat - ratfun = ratfun */
                    sub_ratfun_rat(&r->u.op2.operand2->u.ratfun,
                                   r->u.op2.operand2->u.ratfun,
                                   r->u.op2.operand1->u.rat);
                    negate_ratfun(&r->u.op2.operand2->u.ratfun);
                    *root = r->u.op2.operand2;
     ...
     case op1_type:
          ...
          /* deal with unary minus */
          if (r->u.op1.operator == UMINUS
              && r->u.op1.operand->type == ratfun_type) {
